...
function NavbarBottom() {
  ...
  return (
    <Navbar className="toolbar" bg='light' expand="lg">
      ...
      <Nav.Link onClick={() => { navigate('/login') }} className="navtext"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="icon icon--chart toolbar__icon bi bi-chat-text" viewBox="0 0 16 16">

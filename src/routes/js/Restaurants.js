              ...
              {restaurants.length - 1 == idx ? (
                <div ref={ref}>
                  <Slider {...settings}>
                    {data.images.map((img, i) => {
                      return (
                        <img src={decodeURIComponent(data.images[i].image.replace('https://bobfull.s3.ap-northeast-2.amazonaws.com/https:/', 'https://'))} className='res-img' />
                      )
                    })}
                  </Slider>
                </div>
                ...
                <div>
                  <Slider {...settings}>
                    {data.images.map((img, i) => {
                      return (
                        <img src={decodeURIComponent(data.images[i].image.image.replace('https://bobfull.s3.ap-northeast-2.amazonaws.com/https:/', 'https://'))} className='res-img' />
                      )
                    })}
                  </Slider>
                </div>

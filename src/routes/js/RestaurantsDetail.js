          ...
          <>
            <Slider {...settings}>
              {restaurant.images.map((img, i) => {
                return (
                  <img src={require(decodeURIComponent(restaurant.images[i].image.replace('https://bobfull.s3.ap-northeast-2.amazonaws.com/https:`/', 'https:`/`/'))).default} className='res-detail-img' />
                )
              })}
            </Slider>
